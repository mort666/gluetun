...
func NewProviders(storage Storage, timeNow func() time.Time,
	...
	providerNameToProvider := map[string]Provider{
		...
		providers.Protonvpn:             protonvpn.New(storage, randSource, client, updaterWarner, *credentials.ProtonEmail, *credentials.ProtonPassword, *credentials.ProtonUsername),
